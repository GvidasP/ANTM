...
def ctfidf_rp(dictionary, documents_per_topic_per_time, num_doc, num_words=10):
    count_vectorizer = CountVectorizer(vocabulary=dictionary.token2id).fit(
        documents_per_topic_per_time.content
    )
